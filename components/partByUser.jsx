...
import { getLetters } from '@/constants'

const PartByUser = ({ data, userName }) => {

    return (
        <div>
            <div className='flex justify-between'>
                <div className='flex items-center gap-1'>
                    <div className='text-gray-700 font-semibold'>{userName} {data?.length}</div>
                </div>
